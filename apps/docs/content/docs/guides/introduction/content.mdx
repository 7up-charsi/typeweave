<DocHeader
  title="introduction"
  description="welcome to the Webbo-ui documentation"
/>
...
Webbo-ui is an <Highlight>open-source</Highlight>, <Highlight>simple</Highlight>, <Highlight>customizable</Highlight> and <Highlight>accissible</Highlight> <Highlight>React Typescript</Highlight> ui library built from ground up on top of utility-first <Highlight>tailwindcss</Highlight> framework.
