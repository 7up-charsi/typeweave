...
Webbo-ui is an <Highlight>open-source</Highlight>, <Highlight>simple</Highlight>, <Highlight>customizable</Highlight> and <Highlight>accissible</Highlight> **React Typescript** ui components library built from ground up on top of utility-first **Tailwindcss** framework.
