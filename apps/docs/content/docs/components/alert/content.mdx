...
<StylePaths source="alert" />

## anatomy

<Anatomy source="alert" />
...
<CodeDemo source="alert/variants" />

### titles

use `title` prop to add neat title

<CodeDemo source="alert/titles" />
...
<CodeDemo source="alert/actions" />

### icons

Use the `icon` prop to override an Alert's icon

<CodeDemo source="alert/icon" />
