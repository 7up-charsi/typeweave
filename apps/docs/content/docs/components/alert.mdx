...
<CodeDemo source="alert/colors" preview={<AlertColors />} />
...
<CodeDemo source="alert/variants" preview={<AlertVariants />} />

### titles

use `title` prop to add neat title

<CodeDemo source="alert/titles" preview={<AlertTitles />} />
...
<CodeDemo source="alert/actions" preview={<AlertActions />} />

### icons

Use the `icon` prop to override an Alert's icon

<CodeDemo source="alert/icons" preview={<AlertIcons />} />
