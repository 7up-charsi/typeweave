...
<Props
  data={[
    ...
    },
    {
      ...
      default: 'light',
      description:
        'when creates a theme from scratch. plugin needs to merge your theme with one of predefined themes. in case, if you miss any token it gets from theme to be merged, it allows you to create theme with only your desired changes and remains else same. There are two predefined themes one for light ui named light and other is for dark ui named dark',
    },
    {
      name: 'defaultColors',
      typeAsNode: (
        <>
          see below <a href="native:#plugin-config">defaultColors</a>{' '}
          in PluginConfig, also see{' '}
          <a href="native:#default-theme">default theme</a> below
        </>
      ),
      description:
        'allows you to change predefined themes colors pallete',
    },
    {
      name: 'defaultLayout',
      typeAsNode: (
        <>
          see below <a href="native:#plugin-config">defaultLayout</a>{' '}
          in PluginConfig, also see{' '}
          <a href="native:#default-theme">default theme</a> below
        </>
      ),
      description: 'allows you to change predefined themes layout',
    },
  ]}
/>
