...
export const AppBar = (props: AppBarProps) => {
  ...
  return (
    <div
      ...
      className="sticky top-0 z-50 border-b border-muted-6 bg-background transition-transform max-md:data-[hide=true]:-translate-y-full max-md:data-[hide=false]:data-[scrolled=true]:shadow-md md:bg-background/50 md:backdrop-blur-sm"
    >
      {children}
    </div>
  );
