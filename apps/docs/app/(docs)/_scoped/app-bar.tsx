...
export const AppBar = (props: AppBarProps) => {
  ...
  return (
    <div
      ...
      className="sticky top-0 z-50 border-b border-muted-6 transition-transform max-xl:data-[hide=true]:-translate-y-full max-xl:data-[hide=false]:data-[scrolled=true]:shadow-md xl:bg-background/50 xl:backdrop-blur-sm"
    >
      {children}
    </div>
  );
