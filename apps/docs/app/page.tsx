const Page = () => {
  return (
    <div className="pt-16">
      <h1 className="text-center leading-tight text-6xl font-bold mt-32 text-muted-11 ">
      ...
      <p className="text-center mt-10 text-muted-11 text-xl">
        Make fully functional accessible websites with power of Tailwindcss
      </p>

      <div className="flex justify-center gap-5 mt-10 text-muted-11">
