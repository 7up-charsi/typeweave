...
const _switch = tv({
  slots: {
    ...
    indicator: [
      'pointer-events-none bg-white text-muted-11 absolute z-10 rounded-full left-[2px] translate-x-0 peer-checked:left-[calc(100%-2px)] peer-checked:-translate-x-full transition-[left,transform] [&_svg:first-of-type]:inline-block peer-checked:[&_svg:first-of-type]:hidden [&_svg:last-of-type]:hidden peer-checked:[&_svg:last-of-type]:inline-block flex items-center justify-center',
      peerFocusVisible,
    ],
