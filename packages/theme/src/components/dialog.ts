...
export const dialog = tv({
  slots: {
    content:
      'fixed top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 z-50 flex flex-col bg-paper max-w-md w-full outline-none overflow-hidden rounded p-4 shadow-modal',
