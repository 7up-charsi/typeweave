...
export const menu = tv({
  slots: {
    menu: 'min-w-[160px] bg-paper rounded py-2 outline-none [--arrowFill:theme(colors.muted-9)] shadow-modal',
    item: 'px-2 py-[6px] mx-2 cursor-pointer text-sm select-none flex items-center text-muted-11 outline-none data-[disabled=true]:cursor-default data-[disabled=true]:disabled data-[focused=true]:bg-muted-3 rounded relative overflow-hidden',
    itemIcon:
