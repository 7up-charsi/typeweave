...
const select = tv({
  slots: {
    ...
    option:
      "h-10 flex gap-2 items-center px-2 select-none [&>span]:first-letter:uppercase [&>span]:truncate cursor-pointer data-[disabled=true]:disabled data-[selected=true]:bg-info-200 data-[focused=true]:data-[selected=false]:bg-info-100",
