...
export const menu = tv({
  slots: {
    ...
    item: 'px-2 h-8 cursor-pointer select-none flex items-center gap-1 text-muted-11 outline-none data-[disabled=true]:cursor-default data-[disabled=true]:opacity-50 data-[focused=true]:bg-muted-4 relative overflow-hidden',
    itemIcon:
