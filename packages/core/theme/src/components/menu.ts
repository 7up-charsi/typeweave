...
export const menu = tv({
  slots: {
    ...
    item: 'px-2 h-8 cursor-pointer select-none flex items-center gap-1 text-muted-11 dark:text-mutedDark-11 outline-none data-[disabled=true]:cursor-default data-[disabled=true]:opacity-50 data-[focused=true]:bg-muted-4 dark:data-[focused=true]:bg-mutedDark-4 relative [--rippleBg:theme(colors.muted-800/20%)] overflow-hidden',
    itemIcon:
