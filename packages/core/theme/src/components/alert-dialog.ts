...
export const alertDialog = tv({
  slots: {
    content:
      'fixed top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 z-50 flex flex-col bg-neutral3 max-w-sm w-full outline-none rounded p-4',
    title: 'text-lg font-semibold text-neutral12 mb-2',
    description: 'text-neutral11',
