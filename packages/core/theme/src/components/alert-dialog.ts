...
export const alertDialog = tv({
  slots: {
    content:
      'fixed top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 z-50 flex flex-col max-w-sm w-full outline-none rounded p-4 bg-muted-2',
    title: 'text-lg font-semibold text-muted-11',
    description: 'mt-2 text-muted-11',
